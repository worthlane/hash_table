...
Стоит вспомнить, что имеется intrinsic функция ```_mm_crc32_u32```, возвращаюшая хеш по алгоритму crc32. Это как раз то, что нам нужно. Реализуем хеш с помощью данных функций:
